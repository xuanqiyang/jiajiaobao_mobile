...
var TouchSlide = function(a){
	...
	var setTitle = (opts.setTitle=="false"||opts.setTitle==false)?false:true;
	...
	if( autoPage ){
		...
		navObj.innerHTML=""; 
		var str="";
		if(opts.setTitle == true && opts.title.length){
			for (var i = 0; i<opts.title.length; i++) {
				str+="<li><span>"+title[i]+"</span></li>"
			}
		}else if( opts.autoPage==true|| opts.autoPage=="true" ){ 
